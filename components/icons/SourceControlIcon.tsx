...
interface SourceControllIconProps {
  active: boolean;
  handleClick: () => void;
}
export default function SourceControlIcon({
  active,
  handleClick,
}: SourceControllIconProps) {
  return (
    <Tooltip
    ...
    >
      ...
      >
        <svg
          className={
            active
              ? " leftBarIcon sourceControl active"
              : "leftBarIcon sourceControl"
          }
          width="30"
          height="30"
          viewBox="0 0 24 24"
